...
///
/// Retrieval funnel — Stage 2: High precision
///
/// Receives the broad candidate set from either search executor and uses the fast
/// LLM as a cross-encoder proxy: it scores each document's relevance to the
/// sub-question and returns only the top-K most relevant ones.
///
/// This reduces noise before the Distiller has to synthesise context.
/// </summary>
...
public sealed class RerankerExecutor : Executor<SearchResults>
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // Cap document preview length so the prompt stays concise
        ...
        // Fall back to the first topK documents if parsing fails
